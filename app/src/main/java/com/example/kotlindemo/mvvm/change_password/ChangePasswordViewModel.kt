package com.example.kotlindemo.mvvm.change_password
...
import com.example.kotlindemo.Repository.ChangePasswordRepository
...
open class ChangePasswordViewModel(private val changePasswordRepository: ChangePasswordRepository): ViewModel(), CoroutineScope {
    ...
    fun doChangePassword(map: HashMap<String?, String?>) {

        launch {
            val result = withContext(Dispatchers.IO) {
                changePasswordRepository.changePassword(map)
            }
